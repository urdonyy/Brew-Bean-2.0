            ...
            <tbody>
                <?php foreach ($products as $product): ?>
                    <tr>
                        ...
                        <td>
                            <a href="update.php?product_name=<?= urlencode($product['product_name']) ?>">
                        ...
                        <td>
                        <a href="delete.php?product_name=<?= urlencode($product['product_name']) ?>" onclick="return confirm('Are you sure you want to delete this product?');">
